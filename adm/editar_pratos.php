...
<html>
    ...
    //quebra os resultados em linhas 
    ...
    ?>        
        ...
        <form class="form-horizontal" action="atualizar_pratos.php?idprato=<?php echo $id ?>" method="post" role="form" data-toggle="validator" enctype = "multipart/form-data">
            <div class="form-group">
                ...
                <div class="col-sm-9">
                    <input type="text" class="form-control" name="nprato" id="nprato" value="<?php echo $dados['nome']?>" placeholder="Nome do prato">
            ...
            <div class="form-group">
                    ...
                    <div class="col-sm-9">
                        <select class="form-control" name="categoria" id="categoria">
                            <option value="<?php echo $dados['categoria']?>" selected="selected" disabled="disabled"><?php echo $dados['categoria']?></option>
